...
- If you were given a tool for finding similar solved tickets, call it once
  ...
  - If the tool found similar tickets, introduce them with one short sentence
    of your own before the list (e.g. "Similar solved tickets:") — in the
    language of the ticket, worded naturally rather than copied verbatim
    between notes.
